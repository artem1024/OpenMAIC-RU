export const settingsZhCN = {
  settings: {
    ...
    agentConfigDesc: '管理课堂讨论的AI智能体',
    agentPersona: '能力描述',
    agentActions: '可用动作',
    deleteAgentConfirm: '确定要删除这个智能体吗？',
    noAgents: '还没有配置智能体',
    ...
    providerEdgeTTS: 'Edge TTS (Microsoft)',
    providerElevenLabsTTS: 'ElevenLabs TTS',
    providerGeminiTTS: 'Gemini 2.5 TTS',
...
export const settingsRuRU = {
  settings: {
    ...
    apiBaseUrlDesc: 'Настройте адрес API-эндпоинта',
    apiKeyRequired: 'API-ключ не может быть пустым',
    model: 'Настройка модели',
    modelDesc: 'Настройте ИИ-модели',
    modelPlaceholder: 'Введите или выберите имя модели',
    ttsModel: 'Модель TTS',
    ttsModelDesc: 'Настройте модель TTS',
    ttsModelPlaceholder: 'Введите или выберите имя модели TTS',
    ttsModelOptions: {
      openaiTts: 'OpenAI TTS',
      azureTts: 'Azure TTS',
    },
    ...
    agentSettingsDesc:
      'Выберите агентов для участия в диалоге. Один агент — режим одиночного агента, несколько — режим совместной работы.',
    agentMode: 'Режим агентов',
    agentModePreset: 'Предустановки',
    agentModeAuto: 'Автогенерация',
    agentModeAutoDesc: 'ИИ автоматически сгенерирует подходящие роли',
    autoAgentCount: 'Количество агентов',
    autoAgentCountDesc: 'Количество автоматически генерируемых ролей (включая преподавателя)',
    atLeastOneAgent: 'Выберите хотя бы одного агента',
    singleAgentMode: 'Режим одиночного агента',
    directAnswer: 'Прямой ответ',
    multiAgentMode: 'Режим нескольких агентов',
    agentsCollaborating: 'Совместное обсуждение',
    agentsCollaboratingCount: 'Выбрано агентов для совместного обсуждения: {count}',
    maxTurns: 'Макс. раундов обсуждения',
    maxTurnsDesc:
      'Максимальное количество раундов обсуждения между агентами (одно действие и ответ агента = один раунд)',
    priority: 'Приоритет',
    actions: 'Действия',
    ...
    agentNames: {
      'default-1': 'ИИ-преподаватель',
      'default-2': 'ИИ-ассистент',
      'default-3': 'Весельчак',
      'default-4': 'Почемучка',
    ...
    agentDescriptions: {
      'default-1': 'Ведущий преподаватель с чёткими и структурированными объяснениями',
      'default-2': 'Помогает усвоить материал и разъясняет ключевые моменты',
      'default-3': 'Оживляет атмосферу юмором и делает урок веселее',
      'default-4': 'Полон любопытства, всегда спрашивает «почему» и «как»',
      'default-5': 'Тщательно записывает и систематизирует конспекты уроков',
      'default-6': 'Глубоко анализирует и исследует суть вопросов',
    },
    close: 'Закрыть',
    save: 'Сохранить',
    new: 'Создать',
    ...
    agentConfigTitle: 'Настройка агентов',
    agentConfigDesc: 'Управление ИИ-агентами для обсуждений в классе',
    agentPersona: 'Описание способностей',
    agentActions: 'Доступные действия',
    deleteAgentConfirm: 'Вы уверены, что хотите удалить этого агента?',
    noAgents: 'Агенты пока не настроены',
    createFirstAgent: 'Создать первого агента',
    // Provider settings
    providers: 'Языковые модели',
    addProviderDescription: 'Добавьте собственных провайдеров моделей для расширения набора ИИ-моделей',
    providerNames: {
      openai: 'OpenAI',
      anthropic: 'Claude',
      google: 'Gemini',
    ...
    providerNamePlaceholder: 'Например: Мой прокси OpenAI',
    ...
    cannotDeleteBuiltIn: 'Невозможно удалить встроенного провайдера',
    resetToDefault: 'Сбросить до стандартных',
    resetToDefaultDescription:
      'Восстановить список моделей до стандартной конфигурации (API-ключ и Base URL будут сохранены)',
    resetConfirmDescription:
      'Это удалит все пользовательские модели и восстановит встроенный список моделей. API-ключ и Base URL будут сохранены.',
    confirmReset: 'Подтвердить сброс',
    resetSuccess: 'Конфигурация успешно сброшена до стандартной',
    saveSuccess: 'Настройки сохранены',
    saveFailed: 'Ошибка сохранения, попробуйте ещё раз',
    cannotDeleteBuiltInModel: 'Невозможно удалить встроенную модель',
    cannotEditBuiltInModel: 'Невозможно редактировать встроенную модель',
    ...
    editModelDescription: 'Редактировать конфигурацию и возможности модели',
    ...
    outputWindowLabel: 'Макс. токенов на выходе',
    ...
    saveModel: 'Сохранить',
    modelsManagementDescription:
      'Управление моделями этого провайдера. Для выбора активной модели перейдите в раздел «Общие».',
    // General settings
    howToUse: 'Инструкция',
    step1ConfigureProvider:
      'Перейдите в «Провайдеры моделей», выберите или добавьте провайдера и настройте подключение (API-ключ, Base URL и т.д.)',
    step2SelectModel: 'Выберите модель для использования в разделе «Активная модель» ниже',
    step3StartUsing: 'После сохранения система будет использовать выбранную модель',
    activeModel: 'Активная модель',
    activeModelDescription: 'Выберите модель для ИИ-диалогов и генерации контента',
    selectModel: 'Выбрать модель',
    searchModels: 'Поиск моделей',
    noModelsFound: 'Модели не найдены',
    noConfiguredProviders: 'Нет настроенных провайдеров',
    configureProvidersFirst:
      'Сначала настройте подключение провайдера в разделе «Провайдеры моделей» слева',
    currentlyUsing: 'Текущая модель',
    // TTS settings
    ...
    ttsEnabledDescription: 'При включении речь будет автоматически синтезироваться во время создания курса',
    ...
    providerEdgeTTS: 'Edge TTS (Microsoft)',
    providerElevenLabsTTS: 'ElevenLabs TTS',
    providerGeminiTTS: 'Gemini 2.5 TTS (через ai-gateway)',
    ...
    browserNativeTTSNote:
      'Встроенный TTS браузера не требует настройки и полностью бесплатен, используются системные голоса',
    testTTS: 'Тест TTS',
    testASR: 'Тест ASR',
    testSuccess: 'Тест пройден',
    testFailed: 'Тест не пройден',
    ttsTestText: 'Тестовый текст TTS',
    ttsTestSuccess: 'Тест TTS пройден, аудио воспроизведено',
    ttsTestFailed: 'Тест TTS не пройден',
    asrTestSuccess: 'Распознавание речи успешно',
    asrTestFailed: 'Ошибка распознавания речи',
    asrResult: 'Результат распознавания',
    asrNotSupported: 'Браузер не поддерживает API распознавания речи',
    browserTTSNotSupported: 'Браузер не поддерживает API синтеза речи',
    ...
    fetchVoices: 'Получить список голосов',
    fetchingVoices: 'Получение...',
    voicesFetched: 'Голоса получены',
    fetchVoicesFailed: 'Ошибка получения голосов',
    voiceApiKeyRequired: 'Требуется API-ключ',
    voiceBaseUrlRequired: 'Требуется Base URL',
    ttsTestTextPlaceholder: 'Введите текст для преобразования',
    ttsTestTextDefault: 'Здравствуйте, это тестовое голосовое сообщение.',
    startRecording: 'Начать запись',
    stopRecording: 'Остановить запись',
    recording: 'Запись...',
    transcribing: 'Распознавание...',
    transcriptionResult: 'Результат распознавания',
    noTranscriptionResult: 'Нет результата распознавания',
    ...
    // TTS Voice descriptions (Qwen)
    qwenVoiceCherry: 'Солнечная, тёплая и естественная',
    qwenVoiceSerena: 'Нежная и мягкая',
    qwenVoiceEthan: 'Энергичный и жизнерадостный',
    qwenVoiceChelsie: 'Аниме-подруга',
    qwenVoiceMomo: 'Игривая и весёлая',
    qwenVoiceVivian: 'Милая и дерзкая',
    qwenVoiceMoon: 'Крутая и стильная',
    qwenVoiceMaia: 'Интеллигентная и нежная',
    qwenVoiceKai: 'SPA для ваших ушей',
    qwenVoiceNofish: 'Дизайнер с необычным произношением',
    qwenVoiceBella: 'Маленькая весёлая девочка',
    qwenVoiceJennifer: 'Кинематографический женский голос',
    qwenVoiceRyan: 'Ритмичный, драматичный',
    qwenVoiceKaterina: 'Зрелая леди с запоминающейся интонацией',
    qwenVoiceAiden: 'Американский парень-кулинар',
    qwenVoiceEldricSage: 'Спокойный и мудрый старец',
    qwenVoiceMia: 'Нежная как весенняя вода',
    qwenVoiceMochi: 'Умный ребёнок с детской непосредственностью',
    qwenVoiceBellona: 'Громкий голос, чёткая дикция, живые персонажи',
    qwenVoiceVincent: 'Уникальный хриплый голос, повествующий о войне и чести',
    qwenVoiceBunny: 'Супермилая девочка',
    qwenVoiceNeil: 'Профессиональный ведущий новостей',
    qwenVoiceElias: 'Профессиональный лектор',
    qwenVoiceArthur: 'Простой голос, впитавший годы и табак',
    qwenVoiceNini: 'Мягкий и вкрадчивый голос',
    qwenVoiceEbona: 'Её шёпот как ржавый ключ к глубинам души',
    qwenVoiceSeren: 'Тихий и спокойный голос для засыпания',
    qwenVoicePip: 'Озорной, но полный детской непосредственности',
    qwenVoiceStella: 'Сладкий девичий голос, превращающийся в голос справедливости',
    qwenVoiceBodega: 'Темпераментный испанский дядюшка',
    qwenVoiceSonrisa: 'Энергичная латиноамериканская сеньора',
    qwenVoiceAlek: 'Холод боевого народа, тепло под шерстяным пальто',
    qwenVoiceDolce: 'Томный итальянский дядюшка',
    qwenVoiceSohee: 'Нежная и жизнерадостная кореянка',
    qwenVoiceOnoAnna: 'Озорная подруга детства',
    qwenVoiceLenn: 'Рациональный немецкий юноша в костюме, слушающий пост-панк',
    qwenVoiceEmilien: 'Романтичный французский старший брат',
    qwenVoiceAndre: 'Магнетический, естественный и спокойный мужской голос',
    qwenVoiceRadioGol: 'Футбольный поэт Rádio Gol!',
    qwenVoiceJada: 'Энергичная шанхайская дама',
    qwenVoiceDylan: 'Пекинский парень из хутунов',
    qwenVoiceLi: 'Терпеливый инструктор йоги',
    qwenVoiceMarcus: 'Немногословный, серьёзный — дух старой Шэньси',
    qwenVoiceRoy: 'Юморной и прямолинейный тайваньский парень',
    qwenVoicePeter: 'Тяньцзиньский комик',
    qwenVoiceSunny: 'Сладкоголосая сычуаньская девушка',
    qwenVoiceEric: 'Чэндуский джентльмен',
    qwenVoiceRocky: 'Весёлый и остроумный гонконгец',
    qwenVoiceKiki: 'Милая гонконгская подружка',
    // ASR Language names (native forms - autoglossonyms)
    ...
    'lang_uk-UA': 'Українська (Україна)',
    // PDF settings
    pdfSettings: 'Парсинг PDF',
    pdfParsingSettings: 'Настройки парсинга PDF',
    pdfDescription: 'Выберите движок парсинга PDF с поддержкой извлечения текста, обработки изображений и распознавания таблиц',
    pdfProvider: 'Парсер PDF',
    pdfFeatures: 'Поддерживаемые функции',
    pdfApiKey: 'API-ключ',
    pdfBaseUrl: 'Base URL',
    mineruDescription:
      'MinerU — коммерческий сервис парсинга PDF с поддержкой продвинутых функций: извлечение таблиц, распознавание формул, анализ макета.',
    ...
    mineruApiKeyOptional: 'Требуется только при включённой аутентификации на сервере',
    ...
    // Image Generation settings
    enableImageGeneration: 'Включить ИИ-генерацию изображений',
    imageGenerationDisabledHint: 'При включении изображения будут автоматически генерироваться при создании курса',
    ...
    testImageConnectivity: 'Проверить подключение',
    imageConnectivitySuccess: 'Сервис изображений подключён',
    imageConnectivityFailed: 'Ошибка подключения к сервису изображений',
    ...
    // Video Generation settings
    enableVideoGeneration: 'Включить ИИ-генерацию видео',
    videoGenerationDisabledHint: 'При включении видео будут автоматически генерироваться при создании курса',
    ...
    testVideoConnectivity: 'Проверить подключение',
    videoConnectivitySuccess: 'Сервис видео подключён',
    videoConnectivityFailed: 'Ошибка подключения к сервису видео',
    ...
    videoGenerating: 'Генерация видео (ожидание 1–2 мин.)...',
    videoGenerationWarning: 'Генерация видео обычно занимает 1–2 минуты, пожалуйста, подождите',
    mediaRetry: 'Повторить',
    mediaContentSensitive: 'Извините, контент не прошёл проверку безопасности.',
    ...
    noVisionWarning:
      'Текущая модель не поддерживает зрение. Изображения можно размещать на слайдах, но модель не сможет анализировать их содержимое для оптимизации выбора и макета',
    // Server provider configuration
    serverConfigured: 'Сервер',
    serverConfiguredNotice:
      'Администратор настроил API-ключ для этого провайдера на сервере. Можете использовать его или ввести свой ключ для замены.',
    optionalOverride: 'Необязательно — оставьте пустым для использования серверной конфигурации',
    // Access code
    setupNeeded: 'Требуется настройка',
    modelNotConfigured: 'Выберите модель для начала работы',
    // Clear cache
    dangerZone: 'Опасная зона',
    clearCache: 'Очистить локальный кеш',
    clearCacheDescription:
      'Удалить все локально сохранённые данные, включая записи занятий, историю чатов, кеш аудио и настройки приложения. Это действие нельзя отменить.',
    clearCacheConfirmTitle: 'Вы уверены, что хотите очистить весь кеш?',
    clearCacheConfirmDescription:
      'Это безвозвратно удалит все следующие данные:',
    clearCacheConfirmItems:
      'Классы и сцены, История чатов, Кеш аудио и изображений, Настройки и предпочтения',
    clearCacheConfirmInput: 'Введите «УДАЛИТЬ» для продолжения',
    clearCacheConfirmPhrase: 'УДАЛИТЬ',
    clearCacheButton: 'Безвозвратно удалить все данные',
    clearCacheSuccess: 'Кеш очищен, страница скоро обновится',
    clearCacheFailed: 'Ошибка очистки кеша, попробуйте ещё раз',
    // Web Search settings
    webSearchSettings: 'Поиск в интернете',
    webSearchApiKey: 'Tavily API Key',
    webSearchApiKeyPlaceholder: 'Введите ваш Tavily API Key',
    webSearchApiKeyPlaceholderServer: 'Серверный ключ настроен, можно переопределить',
    webSearchApiKeyHint: 'Получите API-ключ на tavily.com для поиска в интернете',
    webSearchBaseUrl: 'Base URL',
    webSearchServerConfigured: 'Серверный ключ Tavily API настроен',
  ...
  profile: {
    ...
    bioPlaceholder: 'Расскажите о себе — ИИ-преподаватель адаптирует уроки под вас...',
    avatarHint: 'Ваш аватар будет отображаться в обсуждениях и чатах в классе',
    fileTooLarge: 'Изображение слишком большое — выберите файл до 5 МБ',
    invalidFileType: 'Выберите файл изображения',
    editTooltip: 'Нажмите для редактирования профиля',
  },
  media: {
    imageCapability: 'Генерация изображений',
    imageHint: 'Генерация иллюстраций для слайдов',
    videoCapability: 'Генерация видео',
    videoHint: 'Генерация видео для слайдов',
    ttsCapability: 'Синтез речи',
    ttsHint: 'Голосовое сопровождение от ИИ-преподавателя',
    asrCapability: 'Распознавание речи',
    asrHint: 'Голосовой ввод для участия в обсуждении',
    provider: 'Провайдер',
    model: 'Модель',
    voice: 'Голос',
    speed: 'Скорость',
...
export const settingsEnUS = {
  settings: {
    ...
    agentConfigDesc: 'Manage AI agents for classroom discussions',
    agentPersona: 'Persona',
    agentActions: 'Available Actions',
    ...
    providerEdgeTTS: 'Edge TTS (Microsoft)',
    providerElevenLabsTTS: 'ElevenLabs TTS',
    providerGeminiTTS: 'Gemini 2.5 TTS (via ai-gateway)',
