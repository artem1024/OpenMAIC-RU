  ...
  return (
    <div className="flex flex-col h-full p-4 gap-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold">{t('settings.agentConfigTitle')}</h2>
          <p className="text-sm text-muted-foreground">{t('settings.agentConfigDesc')}</p>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    <p className="text-xs font-medium text-muted-foreground mb-1">
                      {t('settings.agentActions')} ({agent.allowedActions.length})
                    </p>
      ...
      {agents.length === 0 && (
        <div className="flex-1 flex items-center justify-center text-center p-8">
          <div className="max-w-sm">
            <p className="text-muted-foreground mb-4">{t('settings.noAgents')}</p>
            <Button>
              <PlusIcon className="w-4 h-4 mr-2" />
              {t('settings.createFirstAgent')}
            </Button>
          </div>
        </div>
      )}
